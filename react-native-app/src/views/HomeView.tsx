...
export const HomeView = () => {
    ...
    const handleStartSession = () => {
        setActiveSession(1); // Set to truthy to light up the UI
        poseDetectorService.startSession();
    };

    const handlePauseSession = () => {
        poseDetectorService.pauseSession();
    };
    ...
    return (
        <View style={styles.container}>
            ...
            {/* SESSION CONTROLS */}
            <View style={[styles.controlBar, { paddingBottom: 0 }]}>
                <TouchableOpacity style={[styles.controlBtn, { backgroundColor: activeSession ? 'rgba(76, 175, 80, 0.6)' : 'rgba(76, 175, 80, 0.3)' }]} onPress={handleStartSession}>
                    <Text style={styles.controlBtnText}>▶️ {activeSession ? `Session Active` : `Start Session`}</Text>
                </TouchableOpacity>
                <TouchableOpacity style={[styles.controlBtn, { backgroundColor: 'rgba(255, 165, 0, 0.3)' }]} onPress={handlePauseSession}>
                    <Text style={styles.controlBtnText}>⏸️ Pause</Text>
                </TouchableOpacity>
                <TouchableOpacity style={[styles.controlBtn, { backgroundColor: 'rgba(244, 67, 54, 0.3)' }]} onPress={handleStopSession}>
                    <Text style={styles.controlBtnText}>⏹️ Stop</Text>
                </TouchableOpacity>
            </View>
